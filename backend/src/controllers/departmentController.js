...
export const listDepartments = async (req, res) => {
  ...
  await Promise.all(departments.map((department) => ensureEnglishTranslation(department, ['departmentName', 'description'])));
...
export const createDepartment = async (req, res) => {
  const payload = {
    ...
    translations: { en: await translateFields(req.body, ['departmentName', 'description']) }
  };
